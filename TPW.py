...
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print(f"{red}Tools cerete by:[ HUMINITORS]")
        ...
        if (len(numbers)>11):
            ...
            sys.exit(" \n \n \n Contact on Telegram HUMINITORS")
            #print(numbers)
...
if(expirydate>today):
    ...
    if (now>Third and now<Thirdend):
        ...
        print(" admin on telegram HUMINITORS  💘 ")
else:
    def clear():
        # for windows
        if name == 'nt':
    ...
    print(" on telegram ----HUMINITORS  💘 for activating")
    ...
    while(True):
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow} HUMINITORS  💘")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI : ")
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print(f"{neon}On Telegram {red}HUMINITORS  💘")
            print("wait.... starting....")
            time.sleep(0.1)
            period=rava
            hero()
            #print("Today Server is off TPW try tomorrow ")
